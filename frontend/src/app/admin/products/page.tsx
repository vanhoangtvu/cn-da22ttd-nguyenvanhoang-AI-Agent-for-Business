                    ...
                    <div>
                      ...
                      <div className="mb-4 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-700">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                          <button
                            type="button"
                            onClick={() => setFormData({ ...formData, details: JSON.stringify({
                              "brand": "Samsung",
                              "model": "Galaxy S24",
                              "storage": "256GB",
                              "color": "Đen titan",
                      ...
                      <textarea
                        ...
                        placeholder='Nhập thông tin chi tiết dưới dạng JSON hoặc chọn template mẫu ở trên để tự động điền...
