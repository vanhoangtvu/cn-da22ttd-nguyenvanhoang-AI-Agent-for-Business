...
export const API_CONFIG = {
  ...
  AI_SERVICE_URL: process.env.NEXT_PUBLIC_AI_SERVICE_URL || 'http://localhost:5000',
  
  // Spring Service (Main Business API)
  API_URL: process.env.NEXT_PUBLIC_API_URL || 'http://localhost:8089/api/v1',
  
  // Groq Chat endpoints
  GROQ_CHAT_BASE: `${process.env.NEXT_PUBLIC_AI_SERVICE_URL || 'http://localhost:5000'}/api/groq-chat`,
};
